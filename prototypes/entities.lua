...
if settings.startup ["osm-pumps-power-priority"].value == true then electric_priority = "primary-input" end
...
if settings.startup["osm-pumps-enable-power"].value == true then
	...
	offshore_pump_0.energy_usage = "400kW"
...
-- Burner pump check
if settings.startup["osm-pumps-burner-offshore-pump"].value == true and settings.startup["osm-pumps-enable-power"].value == true then -- Burner check
	...
	data.raw["assembling-machine"]["offshore-pump-0"].localised_name = {"entity-name.offshore-pump-0-brn"}
	data.raw["offshore-pump"]["offshore-pump-0-placeholder"].localised_name = {"entity-name.offshore-pump-0-placeholder-brn"}
...
-- Water pumpjacks
if settings.startup["osm-pumps-enable-ground-water-pumpjacks"].value == true then
